...
final class ServerInformation_Bootstrap {
    ...
    private function _loadClasses( $sFilePath ) {
        ...
        include( $_sPluginDir . '/include/class/utility/ServerInformation_AutoLoad.php' );
        if ( $this->_bIsAdmin ) {
            include( $_sPluginDir . '/include/library/apf/admin-page-framework.php' );
        }
                    
        // Include the include lists. The including file reassigns the list(array) to the $_aClassFiles variable.
        $_aClassFiles        = array();
        include( $_sPluginDir . '/include/class-list.php' );

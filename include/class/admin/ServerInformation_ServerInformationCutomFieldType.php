<?php
if ( ! class_exists( 'ServerInformation_ServerInformationCutomFieldType' ) ) :
class ServerInformation_ServerInformationCutomFieldType extends ServerInformation_AdminPageFramework_FieldType {
        
    /**
     * Defines the field type slugs used for this field type.
     */
    public $aFieldTypeSlugs = array( 'server_information', );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return <<<CSSRULES
.admin-page-framework-field-server_information {
    width: 100%;
}
.admin-page-framework-field-server_information .admin-page-framework-input-label-container {
    width: 100%;
}
.admin-page-framework-field-server_information textarea {
...
CSSRULES;
    ...
    protected function getField( $aField ) { 
        ...
        $_aInputAttributes['class'] .= ' server_information';

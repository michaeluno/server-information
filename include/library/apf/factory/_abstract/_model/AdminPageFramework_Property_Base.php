 ...
 */
abstract class ServerInformation_AdminPageFramework_Property_Base extends ServerInformation_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = $this->getAOrB(empty($sTextDomain), 'server-information', $sTextDomain);
        $this->sStructureType = $sStructureType;
        $GLOBALS['aServerInformation_AdminPageFramework'] = $this->getElementAsArray($GLOBALS, 'aServerInformation_AdminPageFramework', array('aFieldFlags' => array()));

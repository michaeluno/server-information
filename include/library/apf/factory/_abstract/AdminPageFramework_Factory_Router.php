...
abstract class ServerInformation_AdminPageFramework_Factory_Router {
    ...
    protected function _getFormInstance($oProp) {
        $_sFormClass = "ServerInformation_AdminPageFramework_Form_{$oProp->_sPropertyType}";
        return new $_sFormClass($oProp->aFormArguments, $oProp->aFormCallbacks, $this->oMsg);
    }
    protected $_aResourceClassNameMap = array('admin_page' => 'ServerInformation_AdminPageFramework_Resource_Page', 'network_admin_page' => 'ServerInformation_AdminPageFramework_Resource_Page', 'post_meta_box' => 'ServerInformation_AdminPageFramework_Resource_MetaBox', 'page_meta_box' => 'ServerInformation_AdminPageFramework_Resource_MetaBox_Page', 'post_type' => 'ServerInformation_AdminPageFramework_Resource_PostType', 'taxonomy_field' => 'ServerInformation_AdminPageFramework_Resource_TaxonomyField', 'widget' => 'ServerInformation_AdminPageFramework_Resource_Widget', 'user_meta' => 'ServerInformation_AdminPageFramework_Resource_UserMeta',);
    ...
    protected $_aHelpPaneClassNameMap = array('admin_page' => 'ServerInformation_AdminPageFramework_HelpPane_Page', 'network_admin_page' => 'ServerInformation_AdminPageFramework_HelpPane_Page', 'post_meta_box' => 'ServerInformation_AdminPageFramework_HelpPane_MetaBox', 'page_meta_box' => 'ServerInformation_AdminPageFramework_HelpPane_MetaBox_Page', 'post_type' => null, 'taxonomy_field' => 'ServerInformation_AdminPageFramework_HelpPane_TaxonomyField', 'widget' => 'ServerInformation_AdminPageFramework_HelpPane_Widget', 'user_meta' => 'ServerInformation_AdminPageFramework_HelpPane_UserMeta',);
    ...
    protected $_aLinkClassNameMap = array('admin_page' => 'ServerInformation_AdminPageFramework_Link_Page', 'network_admin_page' => 'ServerInformation_AdminPageFramework_Link_NetworkAdmin', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'ServerInformation_AdminPageFramework_Link_PostType', 'taxonomy_field' => null, 'widget' => null, 'user_meta' => null,);
    ...
    protected $_aPageLoadClassNameMap = array('admin_page' => 'ServerInformation_AdminPageFramework_PageLoadInfo_Page', 'network_admin_page' => 'ServerInformation_AdminPageFramework_PageLoadInfo_NetworkAdminPage', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'ServerInformation_AdminPageFramework_PageLoadInfo_PostType', 'taxonomy_field' => null, 'widget' => null, 'user_meta' => null,);
    ...
    public function _replyTpSetAndGetInstance_oUtil() {
        $this->oUtil = new ServerInformation_AdminPageFramework_FrameworkUtility;
        return $this->oUtil;
    }
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(ServerInformation_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }

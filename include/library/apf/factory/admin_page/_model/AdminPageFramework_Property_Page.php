...
class ServerInformation_AdminPageFramework_Property_Page extends ServerInformation_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'server-information') {
        ...
        $GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aServerInformation_AdminPageFramework', 'aPageClasses'));

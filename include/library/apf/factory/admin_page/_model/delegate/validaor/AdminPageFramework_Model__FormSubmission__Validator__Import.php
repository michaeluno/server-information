 ...
 */
class ServerInformation_AdminPageFramework_Model__FormSubmission__Validator__Import extends ServerInformation_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new ServerInformation_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);

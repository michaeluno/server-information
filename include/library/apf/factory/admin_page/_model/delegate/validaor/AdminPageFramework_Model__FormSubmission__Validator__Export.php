 ...
 */
class ServerInformation_AdminPageFramework_Model__FormSubmission__Validator__Export extends ServerInformation_AdminPageFramework_Model__FormSubmission__Validator__Import {
    ...
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new ServerInformation_AdminPageFramework_ExportOptions($_POST['__export'], $this->oFactory->oProp->sClassName);

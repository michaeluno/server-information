 ...
 */
class ServerInformation_AdminPageFramework_View__PageRenderer__PageHeadingTabs extends ServerInformation_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    private function _getPageHeadingtabNavigationBar(array $aPages, $sTag, $sCurrentPageSlug) {
        ...
        return $_sTabBar ? "<div class='server-information-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }

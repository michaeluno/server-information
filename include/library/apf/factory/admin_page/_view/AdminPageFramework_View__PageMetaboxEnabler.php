 ...
 */
class ServerInformation_AdminPageFramework_View__PageMetaboxEnabler extends ServerInformation_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _isMetaBoxAdded() {
        $_aPageMetaBoxClasses = $this->getElementAsArray($GLOBALS, array('aServerInformation_AdminPageFramework', 'aMetaBoxForPagesClasses'));
    ...
    public function _replyToAddMetaboxScript() {
        $_bLoaded = $this->getElement($GLOBALS, array('aServerInformation_AdminPageFramework', 'bAddedMetaBoxScript'), false);
        if ($_bLoaded) {
            return;
        }
...
JAVASCRIPTS;
        echo '<script class="server-information-insert-metabox-script">' . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . '</script>';
    }
}
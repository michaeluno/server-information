 ...
 */
class ServerInformation_AdminPageFramework_View__Resource extends ServerInformation_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new ServerInformation_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new ServerInformation_AdminPageFramework_Format_PageResource_Script($asPageScript);

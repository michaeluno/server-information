 ...
 */
class ServerInformation_AdminPageFramework_PointerToolTip extends ServerInformation_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertInlineScript() {
        echo "<script type='text/javascript' class='server-information-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInlineScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }

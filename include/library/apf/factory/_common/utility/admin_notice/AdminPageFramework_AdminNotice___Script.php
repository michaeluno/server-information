 ...
 */
class ServerInformation_AdminPageFramework_AdminNotice___Script extends ServerInformation_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.server-information-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='server-information-admin-notice-animation-container'></div>" );

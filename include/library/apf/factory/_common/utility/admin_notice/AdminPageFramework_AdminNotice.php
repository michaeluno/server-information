 ...
 */
class ServerInformation_AdminPageFramework_AdminNotice extends ServerInformation_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'server-information-settings-notice-message', 'server-information-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new ServerInformation_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }

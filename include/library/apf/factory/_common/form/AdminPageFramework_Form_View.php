 ...
 */
class ServerInformation_AdminPageFramework_Form_View extends ServerInformation_AdminPageFramework_Form_Model {
    public function __construct() {
        parent::__construct();
        new ServerInformation_AdminPageFramework_Form_View__Resource($this);
    }
    public function get() {
    ...
    private function _getNoScriptMessage() {
        ...
        return "<noscript>" . "<div class='error'>" . "<p class='server-information-form-warning'>" . $this->oMsg->get('please_enable_javascript') . "</p>" . "</div>" . "</noscript>";
    }

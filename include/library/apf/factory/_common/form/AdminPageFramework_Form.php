 ...
 */
class ServerInformation_AdminPageFramework_Form extends ServerInformation_AdminPageFramework_Form_Controller {
    ...
    public function __construct() {
        ...
        $this->oSubmitNotice = new ServerInformation_AdminPageFramework_Form___SubmitNotice;
        $this->oFieldError = new ServerInformation_AdminPageFramework_Form___FieldError($this->aArguments['caller_id']);
        parent::__construct();
        $this->construct();
    }

 ...
 */
abstract class ServerInformation_AdminPageFramework_Input_Base extends ServerInformation_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'server-information-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'server-information-input-label-string',),);

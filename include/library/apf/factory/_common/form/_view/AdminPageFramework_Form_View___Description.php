 ...
 */
class ServerInformation_AdminPageFramework_Form_View___Description extends ServerInformation_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'server-information-form-element-description';

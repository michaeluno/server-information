 ...
 */
class ServerInformation_AdminPageFramework_Form_View___Script_SortableField extends ServerInformation_AdminPageFramework_Form_View___Script_Base {
    ...
    static public function getScript() {
        return <<<JAVASCRIPTS
(function($) {
    $.fn.enableServerInformation_AdminPageFrameworkSortableFields = function( sFieldsContainerID ) {

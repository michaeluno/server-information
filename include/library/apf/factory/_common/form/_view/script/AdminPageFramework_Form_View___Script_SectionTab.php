 ...
 */
class ServerInformation_AdminPageFramework_Form_View___Script_SectionTab extends ServerInformation_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.server-information-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='server-information-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
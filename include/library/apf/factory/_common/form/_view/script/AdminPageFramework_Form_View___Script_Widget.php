 ...
 */
class ServerInformation_AdminPageFramework_Form_View___Script_Widget extends ServerInformation_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.server-information-sectionset' ).length <= 0 ) { 
                    return; 
                }   

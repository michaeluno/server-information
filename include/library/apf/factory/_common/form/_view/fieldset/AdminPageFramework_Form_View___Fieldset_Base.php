 ...
 */
abstract class ServerInformation_AdminPageFramework_Form_View___Fieldset_Base extends ServerInformation_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    ...
    private function _getFormatted($aFieldset, $aFieldTypeDefinitions) {
        return $this->uniteArrays($aFieldset, $this->_getFieldTypeDefaultArguments($aFieldset['type'], $aFieldTypeDefinitions) + ServerInformation_AdminPageFramework_Form_Model___Format_Fieldset::$aStructure);
    }
    ...
    private function _loadScripts($sStructureType = '') {
        if ('widget' === $sStructureType && !self::$_bIsLoadedSScripts_Widget) {
            new ServerInformation_AdminPageFramework_Form_View___Script_Widget;
        ...
        new ServerInformation_AdminPageFramework_Form_View___Script_Utility;
        new ServerInformation_AdminPageFramework_Form_View___Script_OptionStorage;
        new ServerInformation_AdminPageFramework_Form_View___Script_AttributeUpdator;
        new ServerInformation_AdminPageFramework_Form_View___Script_RepeatableField($this->oMsg);
        new ServerInformation_AdminPageFramework_Form_View___Script_SortableField;
    }
...
jQuery( document ).ready( function() {
    ...
    /* Otherwise, insert the button element at the beginning of the field tag */
        ...
        if ( ! jQuery( '#{$sFieldsContainerID} .server-information-repeatable-field-buttons' ).length ) { 
            // Adds the buttons
            jQuery( '#{$sFieldsContainerID} .server-information-field' ).prepend( $_sButtonsHTML ); 
        }
    }     
    jQuery( '#{$sFieldsContainerID}' ).updateServerInformation_AdminPageFrameworkRepeatableFields( $_aJSArray ); // Update the fields     
});
JAVASCRIPTS;
    ...
    protected function _getSortableFieldEnablerScript($sFieldsContainerID) {
        $_sScript = <<<JAVASCRIPTS
    jQuery( document ).ready( function() {
        jQuery( this ).enableServerInformation_AdminPageFrameworkSortableFields( '$sFieldsContainerID' );
    });
JAVASCRIPTS;
        return "<script type='text/javascript' class='server-information-sortable-field-enabler-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
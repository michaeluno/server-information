 ...
 */
class ServerInformation_AdminPageFramework_Form_View___Fieldset extends ServerInformation_AdminPageFramework_Form_View___Fieldset_Base {
    public function get() {
        $_aOutputs = array();
        $_oFieldError = new ServerInformation_AdminPageFramework_Form_View___Fieldset___FieldError($this->aErrors, $this->aField['_section_path_array'], $this->aField['_field_path_array'], $this->aField['error_message']);
        $_aOutputs[] = $_oFieldError->get();
        $_oFieldsFormatter = new ServerInformation_AdminPageFramework_Form_Model___Format_Fields($this->aField, $this->aOptions);
    ...
    private function _getEachFieldOutput(array $aField, $isIndex, array $aCallbacks, $bIsLastElement = false) {
        ...
        $_oSubFieldFormatter = new ServerInformation_AdminPageFramework_Form_Model___Format_EachField($aField, $isIndex, $aCallbacks, $_aFieldTypeDefinition);
        $aField = $_oSubFieldFormatter->get();
        $_oFieldAttribute = new ServerInformation_AdminPageFramework_Form_View___Attribute_Field($aField);
    ...
    private function _getFinalOutput(array $aFieldset, array $aFieldsOutput, $iFieldsCount) {
        $_oFieldsetAttributes = new ServerInformation_AdminPageFramework_Form_View___Attribute_Fieldset($aFieldset);
    ...
    private function _getFieldsetContent($aFieldset, $aFieldsOutput, $iFieldsCount) {
        ...
        $_oFieldsAttributes = new ServerInformation_AdminPageFramework_Form_View___Attribute_Fields($aFieldset, array(), $iFieldsCount);
    ...
    private function _getExtras($aField, $iFieldsCount) {
        $_aOutput = array();
        $_oFieldDescription = new ServerInformation_AdminPageFramework_Form_View___Description($aField['description'], 'server-information-fields-description');

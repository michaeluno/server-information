 ...
 */
class ServerInformation_AdminPageFramework_Form_View___FieldsetTableRow extends ServerInformation_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getFieldTitle(array $aField) {
        $_oInputTagIDGenerator = new ServerInformation_AdminPageFramework_Form_View___Generate_FieldInputID($aField, 0);
    ...
    private function _getToolTip($asTip, $sElementID) {
        $_oToolTip = new ServerInformation_AdminPageFramework_Form_View___ToolTip($asTip, $sElementID);

 ...
 */
class ServerInformation_AdminPageFramework_Form_View___CollapsibleSectionTitle extends ServerInformation_AdminPageFramework_Form_View___SectionTitle {
    ...
    private function _getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer = 'sections', $iSectionIndex = null) {
        ...
        return $this->_getCollapsibleSectionsEnablerScript() . "<div " . $this->getAttributes(array('id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('server-information-section-title', $this->getAOrB('box' === $aCollapsible['type'], 'accordion-section-title', ''), 'server-information-collapsible-title', $this->getAOrB('sections' === $aCollapsible['container'], 'server-information-collapsible-sections-title', 'server-information-collapsible-section-title'), $this->getAOrB($aCollapsible['is_collapsed'], 'collapsed', ''), 'server-information-collapsible-type-' . $aCollapsible['type']),) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
    }
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        self::$_bLoaded = true;
        new ServerInformation_AdminPageFramework_Form_View___Script_CollapsibleSection($this->oMsg);
    }
}
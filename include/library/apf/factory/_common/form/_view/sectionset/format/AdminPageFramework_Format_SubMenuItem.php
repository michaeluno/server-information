 ...
 * @internal
 */
class ServerInformation_AdminPageFramework_Format_SubMenuItem extends ServerInformation_AdminPageFramework_Format_Base {
    ...
    public function get() {
        ...
        if ( isset( $_aSubMenuItem[ 'page_slug' ] ) ) {
            $_oFormatter = new ServerInformation_AdminPageFramework_Format_SubMenuPage(
                $_aSubMenuItem,
                $this->oFactory,
                $this->iParsedIndex
            );
        ...
        if ( isset( $_aSubMenuItem[ 'href' ] ) ) {
            $_oFormatter = new ServerInformation_AdminPageFramework_Format_SubMenuLink( 
                $_aSubMenuItem,
                $this->oFactory,
                $this->iParsedIndex
            );

 ...
 */
class ServerInformation_AdminPageFramework_Form_View___SectionTitle extends ServerInformation_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getToolTip() {
        ...
        $_oToolTip = new ServerInformation_AdminPageFramework_Form_View___ToolTip($_aSectionset['tip'], $_sSectionTitleTagID);
    ...
    private function _getCollapseButton($aCollapsible) {
        ...
        return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='server-information-collapsible-button server-information-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='server-information-collapsible-button server-information-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
    }
    private function _getSectionTitleField(array $aFieldsetsets, $iSectionIndex, $aFieldTypeDefinitions) {
        foreach ($aFieldsetsets as $_aFieldsetset) {
            ...
            $_oFieldsetOutputFormatter = new ServerInformation_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldsetset, $iSectionIndex, $aFieldTypeDefinitions);

 ...
 */
class ServerInformation_AdminPageFramework_Form_View___FieldsetRow extends ServerInformation_AdminPageFramework_Form_View___FieldsetTableRow {
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new ServerInformation_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);

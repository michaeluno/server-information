 ...
 * @internal
 */
class ServerInformation_AdminPageFramework_Format_SubMenuPage extends ServerInformation_AdminPageFramework_Format_Base {
    
    /**
     * Represents the structure of sub-menu page array.
     * 
     * @since       2.0.0
     * @since       3.1.1       Moved from `ServerInformation_AdminPageFramework_Menu`.
     * @since       3.6.0       Moved from `ServerInformation_AdminPageFramework_Menu_Model`.
     ...
     * 
     * @since       2.0.0
     * @since       3.3.1       Moved from `ServerInformation_AdminPageFramework_Page`.
     * @since       3.6.0       Moved from `ServerInformation_AdminPageFramework_Page_Model`.
     * @var         array
     * @static
     * @access      public
     * @internal

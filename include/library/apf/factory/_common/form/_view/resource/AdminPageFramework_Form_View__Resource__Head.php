 ...
 */
class ServerInformation_AdminPageFramework_Form_View__Resource__Head extends ServerInformation_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    public function _replyToInsertRequiredInlineScripts() {
        ...
        echo "<script type='text/javascript' class='server-information-form-script-required-in-head'>" . '/* <![CDATA[ */ ' . $this->_getScripts_RequiredInHead() . ' /* ]]> */' . "</script>";
    }
    private function _getScripts_RequiredInHead() {
        return 'document.write( "<style class=\'server-information-js-embedded-inline-style\'>' . str_replace('\\n', '', esc_js($this->_getInlineCSS())) . '</style>" );';
    }
    private function _getInlineCSS() {
        $_oLoadingCSS = new ServerInformation_AdminPageFramework_Form_View___CSS_Loading;
    ...
    private function _getScriptElementConcealerCSSRules() {
        return <<<CSSRULES
.server-information-form-js-on {  
    visibility: hidden;
}
.widget .server-information-form-js-on { 
    visibility: visible; 
}
CSSRULES;

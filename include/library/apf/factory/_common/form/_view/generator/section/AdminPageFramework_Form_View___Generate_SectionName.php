 ...
 */
class ServerInformation_AdminPageFramework_Form_View___Generate_SectionName extends ServerInformation_AdminPageFramework_Form_View___Generate_Section_Base {
    public function get() {

 ...
 */
class ServerInformation_AdminPageFramework_Form_View___Generate_FlatFieldName extends ServerInformation_AdminPageFramework_Form_View___Generate_FieldName {
    public function get() {

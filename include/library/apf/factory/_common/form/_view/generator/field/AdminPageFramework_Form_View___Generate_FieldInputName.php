 ...
 */
class ServerInformation_AdminPageFramework_Form_View___Generate_FieldInputName extends ServerInformation_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';

 ...
 */
class ServerInformation_AdminPageFramework_Form_View___Generate_FieldTagID extends ServerInformation_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {

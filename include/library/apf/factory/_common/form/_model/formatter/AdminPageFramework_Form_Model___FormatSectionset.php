 ...
 */
class ServerInformation_AdminPageFramework_Form_Model___FormatSectionset extends ServerInformation_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oCollapsibleArgumentFormatter = new ServerInformation_AdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset['collapsible'], $_aSectionset['title']);

 ...
 */
class ServerInformation_AdminPageFramework_FieldType_taxonomy extends ServerInformation_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new ServerInformation_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableServerInformation_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableServerInformation_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerServerInformation_AdminPageFrameworkCallbacks( {     
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            enableServerInformation_AdminPageFrameworkTabbedBox( jQuery( oCloned ).find( '.tab-box-container' ) );            
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Taxonomy Field Type */
.server-information-field .taxonomy-checklist li { 
    margin: 8px 0 8px 20px; 
}
.server-information-field div.taxonomy-checklist {
    padding: 8px 0 8px 10px;
    margin-bottom: 20px;
}
.server-information-field .taxonomy-checklist ul {
    list-style-type: none;
    margin: 0;
}
.server-information-field .taxonomy-checklist ul ul {
    margin-left: 1em;
}
.server-information-field .taxonomy-checklist-label {
    /* margin-left: 0.5em; */
    white-space: nowrap;     
}    
/* Tabbed box */
.server-information-field .tab-box-container.categorydiv {
    max-height: none;
}
.server-information-field .tab-box-tab-text {
    display: inline-block;
}
.server-information-field .tab-box-tabs {
    line-height: 12px;
    margin-bottom: 0;
}
/* .server-information-field .tab-box-tab {     
    vertical-align: top;
} */
.server-information-field .tab-box-tabs .tab-box-tab.active {
    display: inline;
...
.server-information-field .tab-box-container { 
    position: relative; 
    width: 100%; 
    clear: both;
    margin-bottom: 1em;
}
.server-information-field .tab-box-tabs li a { color: #333; text-decoration: none; }
.server-information-field .tab-box-contents-container {  
    padding: 0 0 0 1.8em;
    padding: 0.55em 0.5em 0.55em 1.8em;
    border: 1px solid #dfdfdf; 
    background-color: #fff;
}
.server-information-field .tab-box-contents { 
    overflow: hidden; 
    overflow-x: hidden; 
    position: relative; 
    top: -1px; 
...
.server-information-field .tab-box-content { 
...
.server-information-field .tab-box-content .taxonomychecklist {
    margin-right: 3.2em;
}
.server-information-field .tab-box-content:target, 
.server-information-field .tab-box-content:target, 
.server-information-field .tab-box-content:target { 
    display: block; 
}  
/* tab-box-content */
.server-information-field .tab-box-content .select_all_button_container, 
.server-information-field .tab-box-content .select_none_button_container
{
    margin-top: 0.8em;
}
/* Nested Checkbox Items */
.server-information-field .taxonomychecklist .children {
    margin-top: 6px;
    margin-left: 1em;
}
CSSRULES;

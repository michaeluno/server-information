 ...
 */
abstract class ServerInformation_AdminPageFramework_FieldType_Base extends ServerInformation_AdminPageFramework_FrameworkUtility {
    ...
    protected function geFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new ServerInformation_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new ServerInformation_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {

...
jQuery( document ).ready( function(){
    ...
    jQuery().registerServerInformation_AdminPageFrameworkCallbacks( {    
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            setServerInformation_AdminPageFrameworkMediaUploader( 
    ...
    private function _getScript_MediaUploader($sReferrer) {
        ...
        if (!function_exists('wp_enqueue_media')) {
            return <<<JAVASCRIPTS
                     ...
                     */
                    setServerInformation_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                        ...
                        jQuery( '#select_media_' + sInputID ).click( function() {
                            ...
                            window.send_to_editor = hfServerInformation_AdminPageFrameworkSendToEditorMedia;
                    ...
                    var hfServerInformation_AdminPageFrameworkSendToEditorMedia = function( sRawHTML, param ) {
        ...
        return <<<JAVASCRIPTS
                ...
                setServerInformation_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                    ...
                    jQuery( '#select_media_' + sInputID ).click( function( e ) {
                        ...
                        oServerInformation_AdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;
                        
                        // Assign a custom select object.
                        wp.media.view.MediaFrame.Select = fExternalSource ? getServerInformation_AdminPageFrameworkCustomMediaUploaderSelectObject() : oServerInformation_AdminPageFrameworkOriginalMediaUploaderSelectObject;
                        ...
                        _oMediaUploader.on( 'close', function() {
                            ...
                            wp.media.view.MediaFrame.Select = oServerInformation_AdminPageFrameworkOriginalMediaUploaderSelectObject;    
                ...
                removeInputValuesForMedia = function( oElem ) {
                    ...
                    var _oImageInput = jQuery( oElem ).closest( '.server-information-field' ).find( '.media-field input' );                  
...
.server-information-field-media input {
    margin-right: 0.5em;
...
jQuery( document ).ready( function(){     
    setServerInformation_AdminPageFrameworkMediaUploader( '{$sInputID}', '{$bRpeatable}', '{$bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='server-information-media-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }

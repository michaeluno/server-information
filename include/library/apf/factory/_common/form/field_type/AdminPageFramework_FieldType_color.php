...
.server-information-field-color .wp-picker-container {
    vertical-align: middle;
}
.server-information-field-color .ui-widget-content {
    border: none;
    background: none;
    color: transparent;
}
.server-information-field-color .ui-slider-vertical {
    width: inherit;
    height: auto;
    margin-top: -11px;
}
.server-information-field-color .server-information-repeatable-field-buttons {
    margin-top: 0;
}
.server-information-field-color .wp-color-result {
...
CSSRULES;
    ...
    protected function getScripts() {
        ...
        $_sDoubleQuote = '\"';
        return <<<JAVASCRIPTS
registerServerInformation_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerServerInformation_AdminPageFrameworkCallbacks( {     
        added_repeatable_field: function( node, sFieldType, sFieldTagID, sCallType ) {
            ...
            registerServerInformation_AdminPageFrameworkColorPickerField( nodeNewColorInput );     
...
JAVASCRIPTS;
    ...
    protected function getField($aField) {
        ...
        return $aField['before_label'] . "<div class='server-information-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span class='server-information-input-label-string' style='min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";'>" . $aField['label'] . "</span>" : "") . "<input " . $this->getAttributes($aField['attributes']) . " />" . $aField['after_input'] . "<div class='repeatable-field-buttons'></div>" . "</label>" . "<div class='colorpicker' id='color_{$aField['input_id']}'></div>" . $this->_getColorPickerEnablerScript("{$aField['input_id']}") . "</div>" . $aField['after_label'];
    }
...
jQuery( document ).ready( function(){
    registerServerInformation_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;

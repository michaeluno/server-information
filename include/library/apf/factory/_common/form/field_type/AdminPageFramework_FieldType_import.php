...
class ServerInformation_AdminPageFramework_FieldType_import extends ServerInformation_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Import Field */
.server-information-field-import input {
    margin-right: 0.5em;
}
.server-information-field-import label,
.form-table td fieldset.server-information-fieldset .server-information-field-import label { /* for Wordpress 3.8 or above */

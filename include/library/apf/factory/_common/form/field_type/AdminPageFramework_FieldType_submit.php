...
class ServerInformation_AdminPageFramework_FieldType_submit extends ServerInformation_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Submit Buttons */
.server-information-field input[type='submit'] {
    margin-bottom: 0.5em;
}
CSSRULES;
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";" : null, 'class' => 'server-information-input-label-container' . ' server-information-input-button-container' . ' server-information-input-container',);
    }

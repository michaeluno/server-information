...
class ServerInformation_AdminPageFramework_FieldType_radio extends ServerInformation_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Radio Field Type */
.server-information-field input[type='radio'] {
    margin-right: 0.5em;
}     
.server-information-field-radio .server-information-input-label-container {
    padding-right: 1em;
}     
.server-information-field-radio .server-information-input-container {
    display: inline;
}     
.server-information-field-radio .server-information-input-label-string  {
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.server-information-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );

 ...
 */
class ServerInformation_AdminPageFramework_FieldType_image extends ServerInformation_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerServerInformation_AdminPageFrameworkCallbacks( {   
        /**
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType, iSectionIndex, iFieldIndex ) {
            ...
            switch( iCallType ) {
                ...
                case 1: 
                    ...
                    var _oSectionsContainer     = jQuery( oCloned ).closest( '.server-information-sections' );
                ...
                case 0:
                    ...
                    var _oFieldsContainer   = jQuery( oCloned ).closest( '.server-information-fields' );
            ...
            // Bind the event.
            var _oFieldContainer = oCloned.closest( '.server-information-field' );
            ...
            setServerInformation_AdminPageFrameworkImageUploader( 
 ...
 */
setServerInformation_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function() {
        ...
        window.send_to_editor           = hfServerInformation_AdminPageFrameworkSendToEditorImage;
...
var hfServerInformation_AdminPageFrameworkSendToEditorImage = function( sRawHTML ) {
...
setServerInformation_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function( e ) {
        ...
        oServerInformation_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
        
        // Assign a custom select object
        wp.media.view.MediaFrame.Select = fExternalSource ? getServerInformation_AdminPageFrameworkCustomMediaUploaderSelectObject() : oServerInformation_AdminPageFrameworkOriginalImageUploaderSelectObject;
        ...
        _oCustomImageUploader.on( 'close', function() {
            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ? jQuery( '#' + sInputID ).closest( '.server-information-field' ) 
                        : _oNewField;
                    _oNewField              = jQuery( this ).addServerInformation_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oServerInformation_AdminPageFrameworkOriginalImageUploaderSelectObject;
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.server-information-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
.server-information-field .image_preview {
    border: none; 
    clear: both; 
    margin-top: 0.4em;
    margin-bottom: 0.8em;
...
.server-information-field .image_preview img {     
    display: block;  
    height: auto; 
    max-width: 100%;
}
.widget .server-information-field .image_preview {
    max-width: 100%;
}            
...
.server-information-field-image input {
    margin-right: 0.5em;
...
jQuery( document ).ready( function(){     
    setServerInformation_AdminPageFrameworkImageUploader( '{$sInputID}', '{$bRpeatable}', '{$bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='server-information-image-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='server-information-{$sType}-remove-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }

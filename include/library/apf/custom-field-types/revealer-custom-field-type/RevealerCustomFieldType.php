 ...
 *      'type'          => 'revealer',     
 *      'title'         => __( 'Reveal Hidden Fields', 'server-information' ),
 *      'default'       => 'undefined',
 *      'label'         => array( // the keys represent the selector to reveal, in this case, their tag id : #fieldrow-{section id}_{field id}
 *          'undefined' => __( '-- Select a Field --', 'server-information' ),     
 *          '#fieldrow-revealer_revealer_field_option_a' => __( 'Option A', 'server-information' ),     
 *          '#fieldrow-revealer_revealer_field_option_b, #fieldrow-revealer_revealer_field_option_c' => __( 'Option B and C', 'server-information' ),
 *          '#fieldrow-revealer_another_revealer_field' => __( 'Another Revealer', 'server-information' ),
 *      ),
 *      'description'   => __( 'Specify the selectors to reveal in the <code>label</code> argument keys in the field definition array.', 'server-information' ),
 *  ),
 *  array(
 *      'field_id'      => 'revealer_field_option_a',
 *      'type'          => 'textarea',     
 *      'default'       => __( 'Hi there!', 'server-information' ),
 *      'hidden'        => true,
 *  ),
 *  array(
 *      'field_id'      => 'revealer_field_option_b',     
 *      'type'          => 'password',     
 *      'description'   => __( 'Type a password.', 'server-information' ),     
 *      'hidden'        => true,
 *  ),
 *  array(
 *      'field_id'      => 'revealer_field_option_c',
 *      'type'          => 'text',     
 *      'description'   => __( 'Type text.', 'server-information' ),     
 *      'hidden'        => true,
 *  ),
 *  array(
 ...
 *      'type'          => 'revealer',  
 *      'select_type'   => 'radio',
 *      'title'         => __( 'Another Hidden Field', 'server-information' ),
 *      'label'         => array( // the keys represent the selector to reveal, in this case, their tag id : #fieldrow-{field id}
 *          '.revealer_field_option_d' => __( 'Option D', 'server-information' ),     
 *          '.revealer_field_option_e' => __( 'Option E', 'server-information' ),
 *          '.revealer_field_option_f' => __( 'Option F', 'server-information' ),
 *      ),
 *      'hidden'        => true,
 ...
 *          'type'          => 'radio',
 *          'label'         => array(
 *              'a' => __( 'A', 'server-information' ),
 *              'b' => __( 'B', 'server-information' ),
 *              'c' => __( 'C', 'server-information' ),
 *          ),
 *          'default'       => 'a',
 *          'class'         => array(
 ...
 *          'type'          => 'select',     
 *          'label'         => array(
 *              'i'     => __( 'i', 'server-information' ),
 *              'ii'    => __( 'ii', 'server-information' ),
 *              'iii'   => __( 'iii', 'server-information' ),
 *          ),                
 *          'default'       => 'ii',
 *          'class'         => array(
 ...
 * 
 * @since       1.0.0
 * @package     ServerInformation_AdminPageFrameworkFieldTypePack
...
class ServerInformation_RevealerCustomFieldType extends ServerInformation_AdminPageFramework_FieldType {
    ...
    protected function setUp() {
        ...
        private function _checkFrameworkVersion() {
            ...
            trigger_error(
                ...
                . sprintf( 
                    __( 'This revealer field type version requires Admin Page Framework %1$s to function properly.', 'server-information' )
                    . ' ' . __( 'You are using the framework version %2$s.', 'server-information' ),
                    '3.7.1',
    ...
    protected function getField( $aField ) { 
            ...
            return 
                "<script type='text/javascript' >"
                    ...
                    . "jQuery( document ).ready( function(){
                        jQuery('*[data-id=\"{$sInputID}\"]').setServerInformation_AdminPageFrameworkRevealer();
                    });"
                    . ' /* ]]> */'
                . "</script>";    
        }        
        private function _getConcealerScript( $sSelectorID, $aLabels, $asCurrentSelection ) {
            ...
            return 
                "<script type='text/javascript' class='server-information-revealer-field-type-concealer-script'>"
                    . '/* <![CDATA[ */ '
                    . "jQuery( document ).ready( function(){
    ...
    public function _replyToAddRevealerjQueryPlugin() {
        ...
        ( function ( $ ) {
             ...
             */
            $.fn.setServerInformation_AdminPageFrameworkRevealer = function() {
        ...
        echo "<script type='text/javascript' class='server-information-revealer-jQuery-plugin'>"
                . '/* <![CDATA[ */ '
                . $_sScript
                . ' /* ]]> */'
            . "</script>";

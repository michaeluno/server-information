 ...
 */
abstract class ServerInformation_AdminPageFramework_Form_Model_Export extends ServerInformation_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new ServerInformation_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);

...
abstract class ServerInformation_AdminPageFramework_Factory_Controller extends ServerInformation_AdminPageFramework_Factory_View {
    ...
    public function setFieldErrors($aErrors) {
        $GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'] = $this->oUtil->getElement($GLOBALS, array('aServerInformation_AdminPageFramework', 'aFieldErrors'), array());
    ...
    public function setSettingNotice($sMessage, $sType = 'error', $asAttributes = array(), $bOverride = true) {
        $GLOBALS['aServerInformation_AdminPageFramework']['aNotices'] = $this->oUtil->getElement($GLOBALS, array('aServerInformation_AdminPageFramework', 'aNotices'), array());
    ...
    public function hasSettingNotice($sType = '') {
        $_aNotices = $this->oUtil->getElementAsArray($GLOBALS, array('aServerInformation_AdminPageFramework', 'aNotices'), array());
        if (!$sType) {

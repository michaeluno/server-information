 ...
 */
class ServerInformation_AdminPageFramework_TabNavigationBar extends ServerInformation_AdminPageFramework_WPUtility {
    public $sTabTag = 'h2';
    public $aTabs = array();
    ...
    private function _getTab(array $aTab) {
        ...
        return $this->generateHTMLTag('a', $_aATagAttributes, $aTab['title']);
    }
}
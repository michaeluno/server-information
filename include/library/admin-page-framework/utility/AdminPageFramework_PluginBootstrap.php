 ...
 */
abstract class ServerInformation_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('ServerInformation_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new ServerInformation_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }

<?php 
/**
	Admin Page Framework - Minified Version v3.4.6b11 by Michael Uno 
...
abstract class ServerInformation_AdminPageFramework_Registry_Base {
    const Version = '3.4.6b11';
...
final class ServerInformation_AdminPageFramework_Registry extends ServerInformation_AdminPageFramework_Registry_Base {
    ...
    static function setUp($sFilePath = null) {
        ...
        self::$sAutoLoaderPath = self::$sDirPath . '/utility/ServerInformation_AdminPageFramework_RegisterClasses.php';
...
final class ServerInformation_AdminPageFramework_Bootstrap {
    function __construct($sLibraryPath) {
        if (!defined('ABSPATH')) {
            return;
        }
        ServerInformation_AdminPageFramework_Registry::setUp($sLibraryPath);
        if (!ServerInformation_AdminPageFramework_Registry::$bIsMinifiedVersion) {
            include (ServerInformation_AdminPageFramework_Registry::$sAutoLoaderPath);
            include (ServerInformation_AdminPageFramework_Registry::$sDirPath . '/admin-page-framework-include-class-list.php');
            new ServerInformation_AdminPageFramework_RegisterClasses(isset($aClassFiles) ? '' : ServerInformation_AdminPageFramework_Registry::$sDirPath, array(), isset($aClassFiles) ? $aClassFiles : array());
        }
    }
}
new ServerInformation_AdminPageFramework_Bootstrap(__FILE__);
if (!class_exists('ServerInformation_AdminPageFramework_Factory_Router')):
    abstract class ServerInformation_AdminPageFramework_Factory_Router {
        public $oProp;
        ...
        protected function _getFormInstance($oProp) {
            switch ($oProp->sFieldsType) {
                ...
                case 'network_admin_page':
                    ...
                    return new ServerInformation_AdminPageFramework_FormElement_Page($oProp->sFieldsType, $oProp->sCapability, $this);
                case 'post_meta_box':
                case 'page_meta_box':
                case 'post_type':
                    if ($oProp->bIsAdminAjax) {
                    ...
                    return new ServerInformation_AdminPageFramework_FormElement($oProp->sFieldsType, $oProp->sCapability, $this);
                case 'taxonomy':
                case 'widget':
                    return new ServerInformation_AdminPageFramework_FormElement($oProp->sFieldsType, $oProp->sCapability, $this);
            }
        ...
        protected function _getResourceInstance($oProp) {
            switch ($oProp->sFieldsType) {
                case 'page':
                case 'network_admin_page':
                    return new ServerInformation_AdminPageFramework_Resource_Page($oProp);
                case 'post_meta_box':
                    return new ServerInformation_AdminPageFramework_Resource_MetaBox($oProp);
                case 'page_meta_box':
                    return new ServerInformation_AdminPageFramework_Resource_MetaBox_Page($oProp);
                case 'post_type':
                    return new ServerInformation_AdminPageFramework_Resource_PostType($oProp);
                case 'taxonomy':
                    return new ServerInformation_AdminPageFramework_Resource_TaxonomyField($oProp);
                case 'widget':
                    return new ServerInformation_AdminPageFramework_Resource_Widget($oProp);
            }
        }
        protected function _getHelpPaneInstance($oProp) {
            switch ($oProp->sFieldsType) {
                case 'page':
                case 'network_admin_page':
                    return new ServerInformation_AdminPageFramework_HelpPane_Page($oProp);
                case 'post_meta_box':
                    return new ServerInformation_AdminPageFramework_HelpPane_MetaBox($oProp);
                case 'page_meta_box':
                    return new ServerInformation_AdminPageFramework_HelpPane_MetaBox_Page($oProp);
                case 'post_type':
                    return null;
                case 'taxonomy':
                    return new ServerInformation_AdminPageFramework_HelpPane_TaxonomyField($oProp);
                case 'widget':
                    return new ServerInformation_AdminPageFramework_HelpPane_Widget($oProp);
            }
        }
        protected function _getLinkInstancce($oProp, $oMsg) {
            switch ($oProp->sFieldsType) {
                case 'page':
                case 'network_admin_page':
                    return new ServerInformation_AdminPageFramework_Link_Page($oProp, $oMsg);
                case 'post_meta_box':
                    return null;
                case 'page_meta_box':
                    return null;
                case 'post_type':
                    return new ServerInformation_AdminPageFramework_Link_PostType($oProp, $oMsg);
                case 'taxonomy':
                case 'widget':
                    return null;
            }
        ...
        protected function _getPageLoadInfoInstance($oProp, $oMsg) {
            switch ($oProp->sFieldsType) {
                case 'page':
                    return ServerInformation_AdminPageFramework_PageLoadInfo_Page::instantiate($oProp, $oMsg);
                case 'network_admin_page':
                    return ServerInformation_AdminPageFramework_PageLoadInfo_NetworkAdminPage::instantiate($oProp, $oMsg);
                case 'post_meta_box':
                    return null;
                case 'page_meta_box':
                    return null;
                case 'post_type':
                    return ServerInformation_AdminPageFramework_PageLoadInfo_PostType::instantiate($oProp, $oMsg);
                case 'taxonomy':
                case 'widget':
                    return null;
            }
        ...
        function __get($sPropertyName) {
            switch ($sPropertyName) {
                case 'oUtil':
                    ...
                    return $this->oUtil;
                case 'oDebug':
                    $this->oDebug = new ServerInformation_AdminPageFramework_Debug;
                    return $this->oDebug;
                case 'oMsg':
                    $this->oMsg = ServerInformation_AdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
                    return $this->oMsg;
                case 'oForm':
...
endif;abstract class ServerInformation_AdminPageFramework_Factory_Model extends ServerInformation_AdminPageFramework_Factory_Router {
    ...
    public function _loadDefaultFieldTypeDefinitions() {
        if (empty(self::$_aFieldTypeDefinitions)) {
            self::$_aFieldTypeDefinitions = ServerInformation_AdminPageFramework_FieldTypeRegistration::register(array(), $this->oProp->sClassName, $this->oMsg);
        }
    ...
    private function _registerField(array $aField) {
        ServerInformation_AdminPageFramework_FieldTypeRegistration::_setFieldResources($aField, $this->oProp, $this->oResource);
        if ($aField['help']) {
    ...
    protected function _isValidationErrors() {
        if (isset($GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors']) && $GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors']) {
            return true;
        }
    ...
    public function _replyToSaveFieldErrors() {
        if (!isset($GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'])) {
            return;
        }
        $this->oUtil->setTransient("apf_field_erros_" . get_current_user_id(), $GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'], 300);
    }
    public function _replyToSaveNotices() {
        if (!isset($GLOBALS['aServerInformation_AdminPageFramework']['aNotices'])) {
            return;
        }
        if (empty($GLOBALS['aServerInformation_AdminPageFramework']['aNotices'])) {
            return;
        }
        $this->oUtil->setTransient('apf_notices_' . get_current_user_id(), $GLOBALS['aServerInformation_AdminPageFramework']['aNotices']);
    }
...
}abstract class ServerInformation_AdminPageFramework_Factory_View extends ServerInformation_AdminPageFramework_Factory_Model {
    function __construct($oProp) {
    ...
    public function _replyToGetFieldOutput($aField) {
        $_oField = new ServerInformation_AdminPageFramework_FormField($aField, $this->oProp->aOptions, $this->_getFieldErrors(), $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
...
}abstract class ServerInformation_AdminPageFramework_Factory_Controller extends ServerInformation_AdminPageFramework_Factory_View {
    ...
    public function setFieldErrors($aErrors) {
        $GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'] = isset($GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors']) ? $GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'] : array();
        if (empty($GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'])) {
            add_action('shutdown', array($this, '_replyToSaveFieldErrors'));
        }
        $_sID = md5($this->oProp->sClassName);
        $GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'][$_sID] = isset($GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'][$_sID]) ? $this->oUtil->uniteArrays($GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'][$_sID], $aErrors) : $aErrors;
    }
    public function hasFieldError() {
        return isset($GLOBALS['aServerInformation_AdminPageFramework']['aFieldErrors'][md5($this->oProp->sClassName) ]);
    }
    public function setSettingNotice($sMessage, $sType = 'error', $asAttributes = array(), $bOverride = true) {
        $GLOBALS['aServerInformation_AdminPageFramework']['aNotices'] = isset($GLOBALS['aServerInformation_AdminPageFramework']['aNotices']) ? $GLOBALS['aServerInformation_AdminPageFramework']['aNotices'] : array();
        if (empty($GLOBALS['aServerInformation_AdminPageFramework']['aNotices'])) {
            add_action('shutdown', array($this, '_replyToSaveNotices'));
        }
        $_sID = md5(trim($sMessage));
        if ($bOverride || !isset($GLOBALS['aServerInformation_AdminPageFramework']['aNotices'][$_sID])) {
            ...
            $GLOBALS['aServerInformation_AdminPageFramework']['aNotices'][$_sID] = array('sMessage' => $sMessage, 'aAttributes' => $_aAttributes + array('class' => $sType, 'id' => $this->oProp->sClassName . '_' . $_sID,),);
        }
    }
    public function hasSettingNotice($sType = '') {
        $_aNotices = isset($GLOBALS['aServerInformation_AdminPageFramework']['aNotices']) ? $GLOBALS['aServerInformation_AdminPageFramework']['aNotices'] : array();
        if (!$sType) {
...
}abstract class ServerInformation_AdminPageFramework_Factory extends ServerInformation_AdminPageFramework_Factory_Controller {
}abstract class ServerInformation_AdminPageFramework_Router extends ServerInformation_AdminPageFramework_Factory {
    ...
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = isset($this->oProp) ? $this->oProp : new ServerInformation_AdminPageFramework_Property_Page($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
...
}abstract class ServerInformation_AdminPageFramework_Form_Model_Port extends ServerInformation_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $oImport = new ServerInformation_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
    ...
    protected function _exportOptions($vData, $sPageSlug, $sTabSlug) {
        $oExport = new ServerInformation_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
...
}abstract class ServerInformation_AdminPageFramework_MetaBox_Router extends ServerInformation_AdminPageFramework_Factory {
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        ...
        $_sClassName = get_class($this);
        parent::__construct(isset($this->oProp) ? $this->oProp : new ServerInformation_AdminPageFramework_Property_MetaBox($this, $_sClassName, $sCapability));
...
}abstract class ServerInformation_AdminPageFramework_MetaBox_Model extends ServerInformation_AdminPageFramework_MetaBox_Router {
    ...
    protected function _setOptionArray($iPostID, $aFields) {
        ...
        $this->oProp->aOptions = ServerInformation_AdminPageFramework_WPUtility::addAndApplyFilter($this, 'options_' . $this->oProp->sClassName, $this->oProp->aOptions);
        $_aLastInput = isset($_GET['field_errors']) && $_GET['field_errors'] ? $this->oProp->aLastInput : array();
        $this->oProp->aOptions = empty($this->oProp->aOptions) ? array() : ServerInformation_AdminPageFramework_WPUtility::getAsArray($this->oProp->aOptions);
...
}abstract class ServerInformation_AdminPageFramework_PostType_Router extends ServerInformation_AdminPageFramework_Factory {
    public function _isInThePage() {
        if (!$this->oProp->bIsAdmin) {
            return false;
        }
...
}abstract class ServerInformation_AdminPageFramework_PostType_Model extends ServerInformation_AdminPageFramework_PostType_Router {
    function __construct($oProp) {
        parent::__construct($oProp);
        if (did_action('init')) {
...
}abstract class ServerInformation_AdminPageFramework_TaxonomyField extends ServerInformation_AdminPageFramework_Factory {
    ...
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new ServerInformation_AdminPageFramework_Property_TaxonomyField($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
    ...
    private function _getFieldsOutput($iTermID, $bRenderTableRow) {
        ...
        $this->oForm->format();
        $_oFieldsTable = new ServerInformation_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->_getFieldErrors(), $this->oMsg);
...
}abstract class ServerInformation_AdminPageFramework_Widget_Router extends ServerInformation_AdminPageFramework_Factory {
    public function __call($sMethodName, $aArgs = null) {
        if ('setup_pre' === $sMethodName) {
            $this->_setUp();
            $this->oUtil->addAndDoAction($this, "set_up_{$this->oProp->sClassName}", $this);
...
}abstract class ServerInformation_AdminPageFramework_Widget_Model extends ServerInformation_AdminPageFramework_Widget_Router {
    function __construct($oProp) {
        parent::__construct($oProp);
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new ServerInformation_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, is_array($this->oProp->aWidgetArguments) ? $this->oProp->aWidgetArguments : array());
    }
...
}abstract class ServerInformation_AdminPageFramework_Form_Model_Validation extends ServerInformation_AdminPageFramework_Form_Model_Port {
...
}abstract class ServerInformation_AdminPageFramework_Form_Model extends ServerInformation_AdminPageFramework_Form_Model_Validation {
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new ServerInformation_AdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
    ...
    public function _replyToRegisterSettings() {
        ...
        $this->oForm->applyFiltersToFields($this, $this->oProp->sClassName);
        $this->oForm->setDynamicElements($this->oProp->aOptions);
        $this->oProp->aFieldTypeDefinitions = ServerInformation_AdminPageFramework_FieldTypeRegistration::register($this->oProp->aFieldTypeDefinitions, $this->oProp->sClassName, $this->oMsg);
            ...
            foreach ($_aSubSectionOrFields as $_sSubSectionIndexOrFieldID => $_aSubSectionOrField) {
                if (is_numeric($_sSubSectionIndexOrFieldID) && is_int($_sSubSectionIndexOrFieldID + 0)) {
                    ...
                    foreach ($_aSubSection as $__sFieldID => $__aField) {
                        ServerInformation_AdminPageFramework_FieldTypeRegistration::_setFieldResources($__aField, $this->oProp, $this->oResource);
                    }
                    continue;
                }
...
}abstract class ServerInformation_AdminPageFramework_MetaBox_View extends ServerInformation_AdminPageFramework_MetaBox_Model {
...
}abstract class ServerInformation_AdminPageFramework_MetaBox_Controller extends ServerInformation_AdminPageFramework_MetaBox_View {
    public function setUp() {
    }
...
}abstract class ServerInformation_AdminPageFramework_MetaBox extends ServerInformation_AdminPageFramework_MetaBox_Controller {
    static protected $_sFieldsType = 'post_meta_box';
    function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        $this->oProp = new ServerInformation_AdminPageFramework_Property_MetaBox($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
}abstract class ServerInformation_AdminPageFramework_PostType_View extends ServerInformation_AdminPageFramework_PostType_Model {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->_isInThePage()) {
...
}abstract class ServerInformation_AdminPageFramework_PostType_Controller extends ServerInformation_AdminPageFramework_PostType_View {
    function __construct($oProp) {
        if (did_action('init')) {
            $this->setup_pre();
        } {
...
}abstract class ServerInformation_AdminPageFramework_PostType extends ServerInformation_AdminPageFramework_PostType_Controller {
    public function __construct($sPostType, $aArgs = array(), $sCallerPath = null, $sTextDomain = 'admin-page-framework') {
        if (empty($sPostType)) {
            return;
        }
        $this->oProp = new ServerInformation_AdminPageFramework_Property_PostType($this, $sCallerPath ? trim($sCallerPath) : ((is_admin() && isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php',))) ? ServerInformation_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), get_class($this), 'publish_posts', $sTextDomain, 'post_type');
        $this->oProp->sPostType = ServerInformation_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArgs;
        parent::__construct($this->oProp);
        $this->oUtil->addAndDoAction($this, "start_{$this->oProp->sClassName}", $this);
    }
}abstract class ServerInformation_AdminPageFramework_Widget_View extends ServerInformation_AdminPageFramework_Widget_Model {
...
}abstract class ServerInformation_AdminPageFramework_Widget_Controller extends ServerInformation_AdminPageFramework_Widget_View {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->_isInThePage()):
            if (did_action('widgets_init')) {
...
}abstract class ServerInformation_AdminPageFramework_Widget extends ServerInformation_AdminPageFramework_Widget_Controller {
    ...
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new ServerInformation_AdminPageFramework_Property_Widget($this, null, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
        $this->oProp->sWidgetTitle = $sWidgetTitle;
        $this->oProp->aWidgetArguments = $aWidgetArguments;
        parent::__construct($this->oProp);
        $this->oUtil->addAndDoAction($this, "start_{$this->oProp->sClassName}", $this);
    }
}abstract class ServerInformation_AdminPageFramework_Form_View extends ServerInformation_AdminPageFramework_Form_Model {
    public function _replyToGetSectionHeaderOutput($sSectionDescription, $aSection) {
        return $this->oUtil->addAndApplyFilters($this, array('section_head_' . $this->oProp->sClassName . '_' . $aSection['section_id']), $sSectionDescription);
    }
    public function _replyToGetFieldOutput($aField) {
        ...
        $_oField = new ServerInformation_AdminPageFramework_FormField($aField, $_aTemp, $this->aFieldErrors, $this->oProp->aFieldTypeDefinitions, $this->oMsg);
...
}abstract class ServerInformation_AdminPageFramework_Form_Controller extends ServerInformation_AdminPageFramework_Form_View {
    public function addSettingSections($aSection1, $aSection2 = null, $_and_more = null) {
        foreach (func_get_args() as $asSection) {
            $this->addSettingSection($asSection);
        }
    ...
    public function getValue() {
        ...
        return ServerInformation_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, $_aParams, null, $this->getSavedOptions() + $this->oProp->getDefaultOptions($this->oForm->aFields));
    }
...
}abstract class ServerInformation_AdminPageFramework_MetaBox_Page_Router extends ServerInformation_AdminPageFramework_MetaBox_View {
...
}abstract class ServerInformation_AdminPageFramework_MetaBox_Page_Model extends ServerInformation_AdminPageFramework_MetaBox_Page_Router {
    static protected $_sFieldsType = 'page_meta_box';
    function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new ServerInformation_AdminPageFramework_Property_MetaBox_Page($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
...
}abstract class ServerInformation_AdminPageFramework_Page_Model extends ServerInformation_AdminPageFramework_Form_Controller {
...
}abstract class ServerInformation_AdminPageFramework_MetaBox_Page_View extends ServerInformation_AdminPageFramework_MetaBox_Page_Model {
}abstract class ServerInformation_AdminPageFramework_MetaBox_Page_Controller extends ServerInformation_AdminPageFramework_MetaBox_Page_View {
...
}abstract class ServerInformation_AdminPageFramework_MetaBox_Page extends ServerInformation_AdminPageFramework_MetaBox_Page_Controller {
    function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
...
}abstract class ServerInformation_AdminPageFramework_Page_View_MetaBox extends ServerInformation_AdminPageFramework_Page_Model {
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['aServerInformation_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['aServerInformation_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['aServerInformation_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['aServerInformation_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['aServerInformation_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['aServerInformation_AdminPageFramework']['bAddedMetaBoxScript'] = true;
...
}abstract class ServerInformation_AdminPageFramework_Page_View extends ServerInformation_AdminPageFramework_Page_View_MetaBox {
    ...
    private function _printMainContent($sPageSlug, $sTabSlug) {
        ...
        if ($this->oProp->bEnableForm && $this->oForm->isPageAdded($sPageSlug)) {
            ...
            $_oFieldsTable = new ServerInformation_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->aFieldErrors, $this->oMsg);
...
}abstract class ServerInformation_AdminPageFramework_Page_Controller extends ServerInformation_AdminPageFramework_Page_View {
...
}abstract class ServerInformation_AdminPageFramework_Menu_Model extends ServerInformation_AdminPageFramework_Page_Controller {
...
}abstract class ServerInformation_AdminPageFramework_Menu_View extends ServerInformation_AdminPageFramework_Menu_Model {
}abstract class ServerInformation_AdminPageFramework_Menu_Controller extends ServerInformation_AdminPageFramework_Menu_View {
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
...
}abstract class ServerInformation_AdminPageFramework_Model extends ServerInformation_AdminPageFramework_Menu_Controller {
...
}abstract class ServerInformation_AdminPageFramework_Controller extends ServerInformation_AdminPageFramework_View {
    public function setUp() {
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return ServerInformation_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}abstract class ServerInformation_AdminPageFramework extends ServerInformation_AdminPageFramework_Controller {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        parent::__construct($sOptionKey, $sCallerPath ? trim($sCallerPath) : $sCallerPath = (is_admin() && (isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page'])) ? ServerInformation_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), $sCapability, $sTextDomain);
        $this->oUtil->addAndDoAction($this, 'start_' . $this->oProp->sClassName, $this);
    }
}abstract class ServerInformation_AdminPageFramework_NetworkAdmin extends ServerInformation_AdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'admin-page-framework') {
        ...
        $sCallerPath = $sCallerPath ? $sCallerPath : ServerInformation_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        $this->oProp = new ServerInformation_AdminPageFramework_Property_NetworkAdmin($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
    }
    protected function _isInstantiatable() {
        if (isset($GLOBALS['pagenow']) && 'admin-ajax.php' === $GLOBALS['pagenow']) {
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return ServerInformation_AdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}
class ServerInformation_AdminPageFramework_Widget_Factory extends WP_Widget {
...
class ServerInformation_AdminPageFramework_ErrorReporting {
...
class ServerInformation_AdminPageFramework_RegisterClasses {
...
class ServerInformation_AdminPageFramework_Requirement {
...
abstract class ServerInformation_AdminPageFramework_Utility_String {
...
}abstract class ServerInformation_AdminPageFramework_Utility_Array extends ServerInformation_AdminPageFramework_Utility_String {
...
}abstract class ServerInformation_AdminPageFramework_Utility_Path extends ServerInformation_AdminPageFramework_Utility_Array {
...
}abstract class ServerInformation_AdminPageFramework_Utility_URL extends ServerInformation_AdminPageFramework_Utility_Path {
...
}abstract class ServerInformation_AdminPageFramework_Utility_File extends ServerInformation_AdminPageFramework_Utility_URL {
...
}abstract class ServerInformation_AdminPageFramework_Utility_SystemInformation extends ServerInformation_AdminPageFramework_Utility_File {
...
}abstract class ServerInformation_AdminPageFramework_Utility extends ServerInformation_AdminPageFramework_Utility_SystemInformation {
...
}class ServerInformation_AdminPageFramework_WPUtility_URL extends ServerInformation_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(ServerInformation_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(ServerInformation_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = ServerInformation_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
}class ServerInformation_AdminPageFramework_WPUtility_HTML extends ServerInformation_AdminPageFramework_WPUtility_URL {
    static public function generateAttributes(array $aAttributes) {
...
}class ServerInformation_AdminPageFramework_WPUtility_Page extends ServerInformation_AdminPageFramework_WPUtility_HTML {
...
}class ServerInformation_AdminPageFramework_WPUtility_Hook extends ServerInformation_AdminPageFramework_WPUtility_Page {
...
}class ServerInformation_AdminPageFramework_WPUtility_File extends ServerInformation_AdminPageFramework_WPUtility_Hook {
...
}class ServerInformation_AdminPageFramework_WPUtility_Option extends ServerInformation_AdminPageFramework_WPUtility_File {
...
}class ServerInformation_AdminPageFramework_WPUtility_Post extends ServerInformation_AdminPageFramework_WPUtility_Option {
...
}class ServerInformation_AdminPageFramework_WPUtility_SystemInformation extends ServerInformation_AdminPageFramework_WPUtility_Post {
...
}class ServerInformation_AdminPageFramework_WPUtility extends ServerInformation_AdminPageFramework_WPUtility_SystemInformation {
...
}abstract class ServerInformation_AdminPageFramework_CustomSubmitFields extends ServerInformation_AdminPageFramework_WPUtility {
...
}class ServerInformation_AdminPageFramework_FormEmail extends ServerInformation_AdminPageFramework_WPUtility {
...
}class ServerInformation_AdminPageFramework_Debug extends ServerInformation_AdminPageFramework_WPUtility {
    ...
    static public function log($vValue, $sFilePath = null) {
        ...
        $_sHeading = date("Y/m/d H:i:s", $_nNow) . '.' . $_nMicroseconds . ' ' . $_sElapsed . '.' . $_sElapsedFloat . ' ' . $_iPageLoadID . ' ' . ServerInformation_AdminPageFramework_Registry::Version . (ServerInformation_AdminPageFramework_Registry::$bIsMinifiedVersion ? '.min' : '') . ' ' . "{$_sCallerClasss}::{$_sCallerFunction} " . current_filter() . ' ' . self::getCurrentURL() . ' ';
...
}abstract class ServerInformation_AdminPageFramework_Link_Base extends ServerInformation_AdminPageFramework_WPUtility {
...
}class ServerInformation_AdminPageFramework_FormElement_Utility extends ServerInformation_AdminPageFramework_WPUtility {
...
}class ServerInformation_AdminPageFramework_FormElement extends ServerInformation_AdminPageFramework_FormElement_Utility {
...
}abstract class ServerInformation_AdminPageFramework_FieldType_Base extends ServerInformation_AdminPageFramework_WPUtility {
    ...
    function __construct($asClassName, $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : ServerInformation_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function geFieldOutput(array $aField) {
        ...
        $_oField = new ServerInformation_AdminPageFramework_FormField($aField, $_aOptions, $_oCaller->getFieldErrors(), $_oCaller->oProp->aFieldTypeDefinitions, $_oCaller->oMsg, $_oCaller->oProp->aFieldCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new ServerInformation_AdminPageFramework_Script_MediaUploader($this->oMsg);
        } else {
...
}abstract class ServerInformation_AdminPageFramework_FieldType extends ServerInformation_AdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
}abstract class ServerInformation_AdminPageFramework_FormOutput extends ServerInformation_AdminPageFramework_WPUtility {
...
}class ServerInformation_AdminPageFramework_FormField_Base extends ServerInformation_AdminPageFramework_FormOutput {
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new ServerInformation_AdminPageFramework_Script_Widget;
        ...
        new ServerInformation_AdminPageFramework_Script_Utility;
        new ServerInformation_AdminPageFramework_Script_OptionStorage;
        new ServerInformation_AdminPageFramework_Script_AttributeUpdator;
        new ServerInformation_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new ServerInformation_AdminPageFramework_Script_Sortable;
        new ServerInformation_AdminPageFramework_Script_RegisterCallback;
    }
...
}class ServerInformation_AdminPageFramework_FormField extends ServerInformation_AdminPageFramework_FormField_Base {
...
}abstract class ServerInformation_AdminPageFramework_Input_Base extends ServerInformation_AdminPageFramework_WPUtility {
    public $aField = array();
...
}class ServerInformation_AdminPageFramework_ExportOptions extends ServerInformation_AdminPageFramework_CustomSubmitFields {
    ...
    public function doExport($vData, $sFileName = null, $sFormatType = null) {
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (is_array($vData) || is_object($vData)) die(ServerInformation_AdminPageFramework_Debug::getArray($vData, null, false));
                die($vData);
            case 'json':
...
}class ServerInformation_AdminPageFramework_ImportOptions extends ServerInformation_AdminPageFramework_CustomSubmitFields {
...
}abstract class ServerInformation_AdminPageFramework_HelpPane_Base extends ServerInformation_AdminPageFramework_Debug {
    protected $_oScreen;
    function __construct($oProp) {
        $this->oProp = $oProp;
        $this->oUtil = new ServerInformation_AdminPageFramework_WPUtility;
...
}class ServerInformation_AdminPageFramework_Link_Page extends ServerInformation_AdminPageFramework_Link_Base {
    private $oProp;
...
}class ServerInformation_AdminPageFramework_Link_PostType extends ServerInformation_AdminPageFramework_Link_Base {
...
}class ServerInformation_AdminPageFramework_FormElement_Page extends ServerInformation_AdminPageFramework_FormElement {
...
}class ServerInformation_AdminPageFramework_FieldType_image extends ServerInformation_AdminPageFramework_FieldType_Base {
...
}class ServerInformation_AdminPageFramework_FieldType_checkbox extends ServerInformation_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('checkbox');
    protected $aDefaultKeys = array('select_all_button' => false, 'select_none_button' => false,);
    protected function getScripts() {
        new ServerInformation_AdminPageFramework_Script_CheckboxSelector;
    ...
    protected function getField($aField) {
        $_aOutput = array();
        $_oCheckbox = new ServerInformation_AdminPageFramework_Input_checkbox($aField);
...
}class ServerInformation_AdminPageFramework_FieldType_color extends ServerInformation_AdminPageFramework_FieldType {
...
}class ServerInformation_AdminPageFramework_FieldType_default extends ServerInformation_AdminPageFramework_FieldType {
...
}class ServerInformation_AdminPageFramework_FieldType_hidden extends ServerInformation_AdminPageFramework_FieldType {
...
}class ServerInformation_AdminPageFramework_FieldType_radio extends ServerInformation_AdminPageFramework_FieldType {
    ...
    protected function getField($aField) {
        $_aOutput = array();
        $_oRadio = new ServerInformation_AdminPageFramework_Input_radio($aField);
...
}class ServerInformation_AdminPageFramework_FieldType_section_title extends ServerInformation_AdminPageFramework_FieldType {
    ...
    protected function getField($aField) {
        $_oSelectInput = new ServerInformation_AdminPageFramework_Input_select($aField);
...
}class ServerInformation_AdminPageFramework_FieldType_submit extends ServerInformation_AdminPageFramework_FieldType {
...
}class ServerInformation_AdminPageFramework_FieldType_export extends ServerInformation_AdminPageFramework_FieldType_submit {
...
}class ServerInformation_AdminPageFramework_FieldType_import extends ServerInformation_AdminPageFramework_FieldType_submit {
...
}class ServerInformation_AdminPageFramework_FieldType_system extends ServerInformation_AdminPageFramework_FieldType {
    ...
    private function _getPHPInfo() {
        ...
        $_oErrorReporting = new ServerInformation_AdminPageFramework_ErrorReporting;
...
}class ServerInformation_AdminPageFramework_FieldType_taxonomy extends ServerInformation_AdminPageFramework_FieldType {
...
}class ServerInformation_AdminPageFramework_FieldType_file extends ServerInformation_AdminPageFramework_FieldType_text {
...
}class ServerInformation_AdminPageFramework_FieldType_number extends ServerInformation_AdminPageFramework_FieldType_text {
...
}class ServerInformation_AdminPageFramework_FieldType_textarea extends ServerInformation_AdminPageFramework_FieldType {
...
}class ServerInformation_AdminPageFramework_FormTable_Base extends ServerInformation_AdminPageFramework_FormOutput {
    ...
    private function _loadScripts() {
        ...
        new ServerInformation_AdminPageFramework_Script_Tab;
    }
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new ServerInformation_AdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new ServerInformation_AdminPageFramework_Script_RepeatableSection($this->oMsg);
...
}class ServerInformation_AdminPageFramework_Input_checkbox extends ServerInformation_AdminPageFramework_Input_Base {
    public function get() {
...
}class ServerInformation_AdminPageFramework_Input_radio extends ServerInformation_AdminPageFramework_Input_Base {
    public function get() {
        $_aParams = func_get_args() + array(0 => '', 1 => array());
        $_sLabel = $_aParams[0];
        $_aAttributes = $_aParams[1];
...
}class ServerInformation_AdminPageFramework_Input_select extends ServerInformation_AdminPageFramework_Input_Base {
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'admin-page-framework-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'admin-page-framework-input-label-string',),);
    public function get() {
...
}class ServerInformation_AdminPageFramework_HelpPane_MetaBox extends ServerInformation_AdminPageFramework_HelpPane_Base {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($oProp->bIsAdminAjax) {
            return;
...
}class ServerInformation_AdminPageFramework_HelpPane_Page extends ServerInformation_AdminPageFramework_HelpPane_Base {
...
}class ServerInformation_AdminPageFramework_FieldType_media extends ServerInformation_AdminPageFramework_FieldType_image {
...
}class ServerInformation_AdminPageFramework_FieldType_posttype extends ServerInformation_AdminPageFramework_FieldType_checkbox {
...
}class ServerInformation_AdminPageFramework_FieldType_size extends ServerInformation_AdminPageFramework_FieldType_select {
    ...
    protected function getField($aField) {
        ...
        $_oUnitInput = new ServerInformation_AdminPageFramework_Input_select($_aUnitField);
...
}class ServerInformation_AdminPageFramework_FormTable_Row extends ServerInformation_AdminPageFramework_FormTable_Base {
    ...
    private function _getFieldRow(array $aField, $hfCallback) {
        ...
        return $this->_getFieldByContainer($aField, $_aFieldFinal, $hfCallback, array('open_container' => "<tr " . $this->_getFieldContainerAttributes($_aFieldFinal, array('id' => 'fieldrow-' . ServerInformation_AdminPageFramework_FormField::_getInputTagBaseID($_aFieldFinal), 'valign' => 'top', 'class' => 'admin-page-framework-fieldrow',), 'fieldrow') . ">", 'close_container' => "</tr>", 'open_title' => "<th>", 'close_title' => "</th>", 'open_main' => "<td " . $this->generateAttributes(array('colspan' => $_aFieldFinal['show_title_column'] ? 1 : 2, 'class' => $_aFieldFinal['show_title_column'] ? null : 'admin-page-framework-field-td-no-title',)) . ">", 'close_main' => "</td>",));
    }
    ...
    private function _getFieldTitle(array $aField) {
        return "<label for='" . ServerInformation_AdminPageFramework_FormField::_getInputID($aField) . "'>" . "<a id='{$aField['field_id']}'></a>" . "<span title='" . esc_attr(strip_tags(isset($aField['tip']) ? $aField['tip'] : (is_array($aField['description'] ? implode('&#10;', $aField['description']) : $aField['description'])))) . "'>" . $aField['title'] . (in_array($aField['_fields_type'], array('widget', 'post_meta_box', 'page_meta_box')) && isset($aField['title']) && '' !== $aField['title'] ? "<span class='title-colon'>:</span>" : '') . "</span>" . "</label>";
    }
}abstract class ServerInformation_AdminPageFramework_FormTable_Caption extends ServerInformation_AdminPageFramework_FormTable_Row {
...
}class ServerInformation_AdminPageFramework_FormTable extends ServerInformation_AdminPageFramework_FormTable_Caption {
    public function getFormTables($aSections, $aFieldsInSections, $hfSectionCallback, $hfFieldCallback) {
        ...
        return implode(PHP_EOL, $_aOutput) . $this->_getSectionTabsEnablerScript() . (defined('WP_DEBUG') && WP_DEBUG && in_array($_sFieldsType, array('widget', 'post_meta_box', 'page_meta_box',)) ? "<div class='admin-page-framework-info'>" . 'Debug Info: ' . ServerInformation_AdminPageFramework_Registry::Name . ' ' . ServerInformation_AdminPageFramework_Registry::getVersion() . "</div>" : '');
    }
...
}class ServerInformation_AdminPageFramework_HelpPane_MetaBox_Page extends ServerInformation_AdminPageFramework_HelpPane_MetaBox {
    protected function _isInThePage() {
...
}class ServerInformation_AdminPageFramework_HelpPane_TaxonomyField extends ServerInformation_AdminPageFramework_HelpPane_MetaBox {
    public function _replyToRegisterHelpTabTextForMetaBox() {
        $this->_setHelpTab($this->oProp->sMetaBoxID, $this->oProp->sTitle, $this->oProp->aHelpTabText, $this->oProp->aHelpTabTextSide);
    }
}class ServerInformation_AdminPageFramework_HelpPane_Widget extends ServerInformation_AdminPageFramework_HelpPane_MetaBox {
}
abstract class ServerInformation_AdminPageFramework_Resource_Base {
    ...
    protected function _printCommonStyles($sIDPrefix, $sClassName) {
        ...
        $_sStyle = $this->oUtil->addAndApplyFilters($_oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), ServerInformation_AdminPageFramework_CSS::getDefaultCSS());
        $_sStyle = $this->oUtil->minifyCSS($_sStyle);
        if ($_sStyle) {
            echo "<style type='text/css' id='" . esc_attr($sIDPrefix) . "'>" . $_sStyle . "</style>";
        }
        $_sStyleIE = $this->oUtil->addAndApplyFilters($_oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), ServerInformation_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->oUtil->addAndApplyFilters($this->oProp->_getCallerObject(), array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), ServerInformation_AdminPageFramework_Property_Base::$_sDefaultScript);
        if ($_sScript) {
...
}class ServerInformation_AdminPageFramework_Resource_MetaBox extends ServerInformation_AdminPageFramework_Resource_Base {
...
}class ServerInformation_AdminPageFramework_Resource_Page extends ServerInformation_AdminPageFramework_Resource_Base {
...
}class ServerInformation_AdminPageFramework_Resource_MetaBox_Page extends ServerInformation_AdminPageFramework_Resource_Page {
}class ServerInformation_AdminPageFramework_Resource_Widget extends ServerInformation_AdminPageFramework_Resource_Base {
...
}class ServerInformation_AdminPageFramework_Resource_PostType extends ServerInformation_AdminPageFramework_Resource_MetaBox {
}class ServerInformation_AdminPageFramework_Resource_TaxonomyField extends ServerInformation_AdminPageFramework_Resource_MetaBox {
...
class ServerInformation_AdminPageFramework_Message {
    ...
    public static function getInstance($sTextDomain = 'admin-page-framework') {
        $_oInstance = isset($_aInstancesByTextDomain[$sTextDomain]) && ($_aInstancesByTextDomain[$sTextDomain] instanceof ServerInformation_AdminPageFramework_Message) ? $_aInstancesByTextDomain[$sTextDomain] : new ServerInformation_AdminPageFramework_Message($sTextDomain);
...
abstract class ServerInformation_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $this->sFieldsType = $sFieldsType;
        $GLOBALS['aServerInformation_AdminPageFramework'] = isset($GLOBALS['aServerInformation_AdminPageFramework']) && is_array($GLOBALS['aServerInformation_AdminPageFramework']) ? $GLOBALS['aServerInformation_AdminPageFramework'] : array('aFieldFlags' => array());
        $this->sPageNow = ServerInformation_AdminPageFramework_WPUtility::getPageNow();
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => ServerInformation_AdminPageFramework_Registry::Name, 'sURI' => ServerInformation_AdminPageFramework_Registry::URI, 'sScriptName' => ServerInformation_AdminPageFramework_Registry::Name, 'sLibraryName' => ServerInformation_AdminPageFramework_Registry::Name, 'sLibraryURI' => ServerInformation_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => ServerInformation_AdminPageFramework_Registry::getVersion(), 'sDescription' => ServerInformation_AdminPageFramework_Registry::Description, 'sAuthor' => ServerInformation_AdminPageFramework_Registry::Author, 'sAuthorURI' => ServerInformation_AdminPageFramework_Registry::AuthorURI, 'sTextDomain' => ServerInformation_AdminPageFramework_Registry::TextDomain, 'sDomainPath' => ServerInformation_AdminPageFramework_Registry::TextDomainPath, 'sNetwork' => '', '_sitewide' => '',);
    ...
    protected function getCallerInfo($sCallerPath = null) {
        ...
        if ('plugin' == $_aCallerInfo['sType']) {
            return ServerInformation_AdminPageFramework_WPUtility::getScriptData($_aCallerInfo['sPath'], $_aCallerInfo['sType']) + $_aCallerInfo;
        }
    ...
    protected function _getLastInput() {
        $_vValue = ServerInformation_AdminPageFramework_WPUtility::getTransient('apf_tfd' . md5('temporary_form_data_' . $this->sClassName . get_current_user_id()));
        if (is_array($_vValue)) {
            return $_vValue;
        }
        return array();
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : ServerInformation_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
...
}class ServerInformation_AdminPageFramework_Property_MetaBox extends ServerInformation_AdminPageFramework_Property_Base {
...
}class ServerInformation_AdminPageFramework_Property_Page extends ServerInformation_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
    ...
    protected function _getOptions() {
        $_aOptions = ServerInformation_AdminPageFramework_WPUtility::addAndApplyFilter($this->oCaller, 'options_' . $this->sClassName, $this->sOptionKey ? get_option($this->sOptionKey, array()) : array());
        $_aLastInput = isset($_GET['field_errors']) && $_GET['field_errors'] ? $this->_getLastInput() : array();
        $_aOptions = empty($_aOptions) ? array() : ServerInformation_AdminPageFramework_WPUtility::getAsArray($_aOptions);
    ...
    private function _getDefautValue($aField) {
        $_aSubFields = ServerInformation_AdminPageFramework_Utility::getIntegerElements($aField);
...
}class ServerInformation_AdminPageFramework_Property_NetworkAdmin extends ServerInformation_AdminPageFramework_Property_Page {
    public $_sPropertyType = 'network_admin_page';
    public $sFieldsType = 'network_admin_page';
    protected function _getOptions() {
        return ServerInformation_AdminPageFramework_WPUtility::addAndApplyFilter($GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses'][$this->sClassName], 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
    public function updateOption($aOptions = null) {
        if ($this->_bDisableSavingOptions) {
            return;
...
}class ServerInformation_AdminPageFramework_Property_PostType extends ServerInformation_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        switch ($this->_getCallerType($sCallerPath)) {
            case 'theme':
                add_action('after_switch_theme', array('ServerInformation_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
            case 'plugin':
                register_activation_hook($sCallerPath, array('ServerInformation_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
                register_deactivation_hook($sCallerPath, array('ServerInformation_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
        }
    }
}class ServerInformation_AdminPageFramework_Property_Widget extends ServerInformation_AdminPageFramework_Property_Base {
...
}class ServerInformation_AdminPageFramework_Property_MetaBox_Page extends ServerInformation_AdminPageFramework_Property_MetaBox {
    ...
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['aServerInformation_AdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['aServerInformation_AdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['aServerInformation_AdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['aServerInformation_AdminPageFramework']['aMetaBoxForPagesClasses'] : array();
        $GLOBALS['aServerInformation_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['aServerInformation_AdminPageFramework']['aPageClasses'] as $__oClass) {
...
}class ServerInformation_AdminPageFramework_Property_TaxonomyField extends ServerInformation_AdminPageFramework_Property_MetaBox {
    public $_sPropertyType = 'taxonomy_field';
    public $aTaxonomySlugs;
    public $sOptionKey;
}
class ServerInformation_AdminPageFramework_FieldTypeRegistration {
    ...
    static public function register($aFieldTypeDefinitions, $sExtendedClassName, $oMsg) {
        foreach (self::$aDefaultFieldTypeSlugs as $_sFieldTypeSlug) {
            $_sFieldTypeClassName = "ServerInformation_AdminPageFramework_FieldType_{$_sFieldTypeSlug}";
...
class ServerInformation_AdminPageFramework_WalkerTaxonomyChecklist extends Walker_Category {
    function start_el(&$sOutput, $oTerm, $iDepth = 0, $aArgs = array(), $iCurrentObjectID = 0) {
        ...
        $sOutput.= "\n" . "<li " . ServerInformation_AdminPageFramework_WPUtility::generateAttributes($_aLiTagAttributes) . ">" . "<label for='{$_sID}' class='taxonomy-checklist-label'>" . "<input value='0' type='hidden' name='{$aArgs['name']}[{$_iID}]' class='apf_checkbox' />" . "<input " . ServerInformation_AdminPageFramework_WPUtility::generateAttributes($_aInputAttributes) . " />" . esc_html(apply_filters('the_category', $oTerm->name)) . $_sPostCount . "</label>";
    }
}
abstract class ServerInformation_AdminPageFramework_PageLoadInfo_Base {
...
}class ServerInformation_AdminPageFramework_PageLoadInfo_NetworkAdminPage extends ServerInformation_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new ServerInformation_AdminPageFramework_PageLoadInfo_NetworkAdminPage($oProp, $oMsg);
...
}class ServerInformation_AdminPageFramework_PageLoadInfo_Page extends ServerInformation_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    public static function instantiate($oProp, $oMsg) {
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new ServerInformation_AdminPageFramework_PageLoadInfo_Page($oProp, $oMsg);
        return self::$_oInstance;
    }
    public function _replyToSetPageLoadInfoInFooter() {
        if ($this->oProp->isPageAdded()) {
...
}class ServerInformation_AdminPageFramework_PageLoadInfo_PostType extends ServerInformation_AdminPageFramework_PageLoadInfo_Base {
    private static $_oInstance;
    private static $aClassNames = array();
    public static function instantiate($oProp, $oMsg) {
        if (in_array($oProp->sClassName, self::$aClassNames)) return self::$_oInstance;
        self::$aClassNames[] = $oProp->sClassName;
        self::$_oInstance = new ServerInformation_AdminPageFramework_PageLoadInfo_PostType($oProp, $oMsg);
        return self::$_oInstance;
    }
    public function _replyToSetPageLoadInfoInFooter() {
        ...
        if (ServerInformation_AdminPageFramework_WPUtility::getCurrentPostType() == $this->oProp->sPostType || ServerInformation_AdminPageFramework_WPUtility::isPostDefinitionPage($this->oProp->sPostType) || ServerInformation_AdminPageFramework_WPUtility::isCustomTaxonomyPage($this->oProp->sPostType)) {
            add_filter('update_footer', array($this, '_replyToGetPageLoadInfo'), 999);
        }
    }
}
class ServerInformation_AdminPageFramework_Script_Base {
...
}class ServerInformation_AdminPageFramework_Script_AttributeUpdator extends ServerInformation_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
}class ServerInformation_AdminPageFramework_Script_CheckboxSelector extends ServerInformation_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
}class ServerInformation_AdminPageFramework_Script_CollapsibleSection extends ServerInformation_AdminPageFramework_Script_Base {
...
}class ServerInformation_AdminPageFramework_Script_MediaUploader extends ServerInformation_AdminPageFramework_Script_Base {
    public function construct() {
        wp_enqueue_script('jquery');
        if (function_exists('wp_enqueue_media')) {
...
}class ServerInformation_AdminPageFramework_Script_OptionStorage extends ServerInformation_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
}class ServerInformation_AdminPageFramework_Script_RegisterCallback extends ServerInformation_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
}class ServerInformation_AdminPageFramework_Script_RepeatableField extends ServerInformation_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
}class ServerInformation_AdminPageFramework_Script_RepeatableSection extends ServerInformation_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
}class ServerInformation_AdminPageFramework_Script_Tab extends ServerInformation_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
}class ServerInformation_AdminPageFramework_Script_Utility extends ServerInformation_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
...
}class ServerInformation_AdminPageFramework_Script_Widget extends ServerInformation_AdminPageFramework_Script_Base {
    static public function getScript() {
        $_aParams = func_get_args() + array(null);
        $_oMsg = $_aParams[0];
